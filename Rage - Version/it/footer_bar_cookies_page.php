    ...
    $(document).ready(function () {
        window.addEventListener("load", function(){
            window.cookieconsent.initialise({
                ...
                "theme": "classic",
                "content": {
                    "message": "Questo sito usa cookies per assicurare la miglior esperienza sul nostro sito internet.<br>Puoi anche cambiare la configurazionedei cookies  <a href='cookies'>qui</a><br>",
                    "link": "Per saperne di piú ",
                    "dismiss": "Ho capito",
                    "href": "privacy-policy"
                }
            })});
...
if($pos){
    ...
    <script>
        $(document).ready(function () {
            ...
            let data_slider_ticks_labels=["Cookies necessari<br>","Cookies funzionali <br>& promotori di pubblicitá"];
