    ...
    $(document).ready(function () {
        window.addEventListener("load", function(){
            window.cookieconsent.initialise({
                ...
                "theme": "classic",
                "content": {
                    "message": "Acest website folosește cookie-uri pentru a te asigura că beneficiezi de cea mai bună experiență pe website-ul nostru..<br>De asemenea, poți modifica setările cookie-urilor  <a href='cookies'>aici</a><br>",
                    "link": "Află mai multe",
                    "dismiss": "Am înțeles",
...
if($pos){
    ...
    <script>
        $(document).ready(function () {
            ...
            let data_slider_ticks_labels=["Cookie-uri strict necesare<br>","Cookie-uri funcționale <br> și de advertising "];
