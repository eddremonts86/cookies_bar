    ...
    $(document).ready(function () {
        window.addEventListener("load", function(){
            window.cookieconsent.initialise({
                ...
                "theme": "classic",
                "content": {
                    "message": "Deze website gebruikt cookies om de gebruikers ervaring te verbeteren.<br>Je kan je cookies configuratie ook  <a href='cookies'>hier aanpassen</a><br>",
                    "link": "Details",
                    "dismiss": "Begrepen",
                    "href": "privacy-policy"
                }
...
<link rel="stylesheet" href="https://cdnjs.cloudflare.com/ajax/libs/bootstrap-slider/10.0.2/css/bootstrap-slider.min.css">
    ...
    <script>
        $(document).ready(function () {
            ...
            let data_slider_ticks_labels=["Vereiste cookies<br>","Functionele en <br>advertentie cookies  "];
